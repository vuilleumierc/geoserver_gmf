...
import geoserver_gmf_geoportal.authentication
import geoserver_gmf_geoportal.dev
import geoserver_gmf_geoportal.multi_organization
...
from geoserver_gmf_geoportal.resources import Root
...
def main(global_config, **settings):
    ...
    config.include(geoserver_gmf_geoportal.authentication.includeme)
    ...
    config.include(geoserver_gmf_geoportal.multi_organization.includeme)
    ...
    config.include(geoserver_gmf_geoportal.dev.includeme)
